...
export default function OffersRow() {
  ...
  // Scroll to button after expansion animation completes
  useEffect(() => {
    if (expandedIdx !== null) {
      const timer = setTimeout(() => {
        const btn = buttonRefs.current[expandedIdx]
        if (btn) {
  ...
  return (
    <section className={styles.offersSection}>
      ...
      <p
        ...
        style={{ marginBottom: '2rem', fontSize: '1rem', color: '#ccc' }}
      >
        Explore our limited‑time specials below and discover how you can save on
        premium detailing services—unlock your exclusive discount today!
      </p>
